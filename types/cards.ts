...
export type CardType = 'genre' | 'text' | 'author' | 'topic' | 'meme' | 'commentary' | 'comment';
...
export type FeedCard = GenreCard | TextCard | CommentaryCard | AuthorCard | TopicCard | MemeFeedCard | CommentFeedCard;
